 ...
 * source of truth in `@zconsole/console-shared`, shared with alchemy.run.ts. This module re-exports
 * it and adds `dbForSlug`, which resolves a slug to its bound D1 on the host's `Env`.
 */
import type { Env } from './types'
import { MANAGED_APPS } from '@zconsole/console-shared'

export { MANAGED_APPS, type ManagedApp, type ChildBindingKey } from '@zconsole/console-shared'
